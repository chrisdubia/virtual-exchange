  ...
  Find Matches
      ...
      <div className="bg-white rounded-3xl shadow-lg p-12 text-center border border-gray-100">
        <div className="flex justify-center mb-6">
          <svg viewBox="0 0 612 792" className="w-24 h-auto" xmlns="http://www.w3.org/2000/svg">
  <defs>
    <style>
      {`.st0{fill:none}.st1{fill:#010101}.st2{fill:#FDC20F}.st3{fill:#E2D7CF}`}
    </style>
  </defs>
  <g>
    <g>
      <ellipse transform="matrix(0.9696 -0.2446 0.2446 0.9696 -75.5453 85.382)" className="st0" cx="306" cy="346.9" rx="29.7" ry="29.7"/>
      <polygon className="st1" points="323.4,505.1 288.6,505.1 306,533.4"/>
    </g>
    <path className="st2" d="M273.8,481c3.6-2.5,8-4,12.7-4c8.4,0,15.8,4.7,19.5,11.6c3.8-6.9,11.1-11.6,19.5-11.6c4.7,0,9.1,1.5,12.7,4l0.7-1.2c27.4-47.9,61.3-103.9,61.3-133c0-67.8-56.9-88.2-94.2-88.2c0,0,0,0,0,0c0,0,0,0,0,0c-37.3,0-94.2,20.4-94.2,88.2c0,29.1,33.8,85,61.3,133L273.8,481z M306,317.2c16.4,0,29.7,13.3,29.7,29.7c0,16.4-13.3,29.7-29.7,29.7c-16.4,0-29.7-13.3-29.7-29.7C276.3,330.5,289.6,317.2,306,317.2z"/>
    <g>
      <path className="st3" d="M323.4,505.1l14.8-24.1c-3.6-2.5-8-4-12.7-4c-8.4,0-15.8,4.7-19.5,11.6c-3.8-6.9-11.1-11.6-19.5-11.6c-4.7,0-9.1,1.5-12.7,4l14.8,24.1H323.4z"/>
    </g>
  </g>
</svg>
        </div>
